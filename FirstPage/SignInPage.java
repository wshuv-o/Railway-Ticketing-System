...
public class SignInPage implements ActionListener
{
    ...
    public SignInPage(Person p){
        ...
        image = new ImageIcon("userprofile/bangladesh-railway.png");
	...
	public void actionPerformed(ActionEvent e) 
	{
		...
		// {
		// 	frame.setVisible(false);
		// 	new ResetPasswordGUI(person);
		// }
		
		if(e.getSource()==buttonSignUp)
		{
			frame.setVisible(false);
			new SignUpPage(person);
		}
	}
...
return count;
	...
	public  void FromFile() throws Exception {
		...
		try{
		   ...
		   writer.write(c);
		  // writer.append("Sarwar Shakib,8888877421245648,974,2025/04,1000,01894949749,jojoo");
		   writer.close();
