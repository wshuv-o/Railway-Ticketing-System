...
public class ANotice implements  ActionListener{
	...
	ANotice(){
		...
		button2= new JButton("Delete Train");
	
	
        JTextField nameTF1 = new JTextField();
        nameTF1.setLayout(null);
        nameTF1.setBounds(5,5, 500, 320);
        nameTF1.setOpaque(false);
        nameTF1.setForeground(new Color(0x000000));
        nameTF1.setFont(font);
		...
		// lowerPanel.add(nameTF1);
        lowerPanel.add(scrollableTextArea);
