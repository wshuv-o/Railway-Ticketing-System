...
public class AUsers implements  ActionListener{
	...
	AUsers(){
		...
		button1= new JButton("Search Users");
		button2= new JButton("Delete Users");
	
	

		button1.setIcon(new ImageIcon("view1.png"));
		...
		button2.setIcon(new ImageIcon("delete1.png"));
